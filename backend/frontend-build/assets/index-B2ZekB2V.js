...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function gc(e,t,n){let r=new Float32Array(nc),i=new U(0,1,0);return new Ro({name:`SphericalGaussianBlur`,defines:{n:nc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:yc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _c(){return new Ro({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:yc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vc(){return new Ro({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:yc(),fragmentShader:`
	...
	`}var bc=class extends Qr{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new wo(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,ad=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),od=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),sd=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),cd=e=>{let t=sd(e);return t.charAt(0).toUpperCase()+t.slice(1)},ld={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},ud=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0;return!1},dd=(0,v.createContext)({}),fd=()=>(0,v.useContext)(dd),pd=(0,v.forwardRef)(({color:e,size:t,strokeWidth:n,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>{let{size:l=24,strokeWidth:u=2,absoluteStrokeWidth:d=!1,color:f=`currentColor`,className:p=``}=fd()??{},m=r??d?Number(n??u)*24/Number(t??l):n??u;return(0,v.createElement)(`svg`,{ref:c,...ld,width:t??l??ld.width,height:t??l??ld.height,stroke:e??f,strokeWidth:m,className:ad(`lucide`,p,i),...!a&&!ud(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,v.createElement)(e,t)),...Array.isArray(a)?a:[a]])}),md=(e,t)=>{let n=(0,v.forwardRef)(({className:n,...r},i)=>(0,v.createElement)(pd,{ref:i,iconNode:t,className:ad(`lucide-${od(cd(e))}`,`lucide-${e}`,n),...r}));return n.displayName=cd(e),n},hd=md(`chevron-down`,[[`path`,{d:`m6 9 6 6 6-6`,key:`qrunsl`}]]),gd=md(`chevron-right`,[[`path`,{d:`m9 18 6-6-6-6`,key:`mthhwq`}]]),_d=md(`chevron-up`,[[`path`,{d:`m18 15-6-6-6 6`,key:`153udz`}]]),vd=md(`gamepad-2`,[[`line`,{x1:`6`,x2:`10`,y1:`11`,y2:`11`,key:`1gktln`}],[`line`,{x1:`8`,x2:`8`,y1:`9`,y2:`13`,key:`qnk9ow`}],[`line`,{x1:`15`,x2:`15.01`,y1:`12`,y2:`12`,key:`krot7o`}],[`line`,{x1:`18`,x2:`18.01`,y1:`10`,y2:`10`,key:`1lcuu1`}],[`path`,{d:`M17.32 5H6.68a4 4 0 0 0-3.978 3.59c-.006.052-.01.101-.017.152C2.604 9.416 2 14.456 2 16a3 3 0 0 0 3 3c1 0 1.5-.5 2-1l1.414-1.414A2 2 0 0 1 9.828 16h4.344a2 2 0 0 1 1.414.586L17 18c.5.5 1 1 2 1a3 3 0 0 0 3-3c0-1.545-.604-6.584-.685-7.258-.007-.05-.011-.1-.017-.151A4 4 0 0 0 17.32 5z`,key:`mfqc10`}]]),yd=md(`gamepad`,[[`line`,{x1:`6`,x2:`10`,y1:`12`,y2:`12`,key:`161bw2`}],[`line`,{x1:`8`,x2:`8`,y1:`10`,y2:`14`,key:`1i6ji0`}],[`line`,{x1:`15`,x2:`15.01`,y1:`13`,y2:`13`,key:`dqpgro`}],[`line`,{x1:`18`,x2:`18.01`,y1:`11`,y2:`11`,key:`meh2c`}],[`rect`,{width:`20`,height:`12`,x:`2`,y:`6`,rx:`2`,key:`9lu3g6`}]]),bd=md(`log-out`,[[`path`,{d:`m16 17 5-5-5-5`,key:`1bji2h`}],[`path`,{d:`M21 12H9`,key:`dn1m92`}],[`path`,{d:`M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4`,key:`1uf3rs`}]]),xd=md(`maximize`,[[`path`,{d:`M8 3H5a2 2 0 0 0-2 2v3`,key:`1dcmit`}],[`path`,{d:`M21 8V5a2 2 0 0 0-2-2h-3`,key:`1e4gt3`}],[`path`,{d:`M3 16v3a2 2 0 0 0 2 2h3`,key:`wsl5sc`}],[`path`,{d:`M16 21h3a2 2 0 0 0 2-2v-3`,key:`18trek`}]]),Sd=md(`minimize`,[[`path`,{d:`M8 3v3a2 2 0 0 1-2 2H3`,key:`hohbtr`}],[`path`,{d:`M21 8h-3a2 2 0 0 1-2-2V3`,key:`5jw1f3`}],[`path`,{d:`M3 16h3a2 2 0 0 1 2 2v3`,key:`198tvr`}],[`path`,{d:`M16 21v-3a2 2 0 0 1 2-2h3`,key:`ph8mxp`}]]),Cd=md(`monitor-play`,[[`path`,{d:`M15.033 9.44a.647.647 0 0 1 0 1.12l-4.065 2.352a.645.645 0 0 1-.968-.56V7.648a.645.645 0 0 1 .967-.56z`,key:`vbtd3f`}],[`path`,{d:`M12 17v4`,key:`1riwvh`}],[`path`,{d:`M8 21h8`,key:`1ev6f3`}],[`rect`,{x:`2`,y:`3`,width:`20`,height:`14`,rx:`2`,key:`x3v2xh`}]]),wd=md(`pause`,[[`rect`,{x:`14`,y:`3`,width:`5`,height:`18`,rx:`1`,key:`kaeet6`}],[`rect`,{x:`5`,y:`3`,width:`5`,height:`18`,rx:`1`,key:`1wsw3u`}]]),Td=md(`play`,[[`path`,{d:`M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z`,key:`10ikf1`}]]),Ed=md(`plus`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`M12 5v14`,key:`s699le`}]]),Dd=md(`settings`,[[`path`,{d:`M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915`,key:`1i5ecw`}],[`circle`,{cx:`12`,cy:`12`,r:`3`,key:`1v7zrd`}]]),Od=md(`skip-back`,[[`path`,{d:`M17.971 4.285A2 2 0 0 1 21 6v12a2 2 0 0 1-3.029 1.715l-9.997-5.998a2 2 0 0 1-.003-3.432z`,key:`15892j`}],[`path`,{d:`M3 20V4`,key:`1ptbpl`}]]),kd=md(`skip-forward`,[[`path`,{d:`M21 4v16`,key:`7j8fe9`}],[`path`,{d:`M6.029 4.285A2 2 0 0 0 3 6v12a2 2 0 0 0 3.029 1.715l9.997-5.998a2 2 0 0 0 .003-3.432z`,key:`zs4d6`}]]),Ad=md(`smartphone`,[[`rect`,{width:`14`,height:`20`,x:`5`,y:`2`,rx:`2`,ry:`2`,key:`1yt0o3`}],[`path`,{d:`M12 18h.01`,key:`mhygvu`}]]),jd=md(`trash-2`,[[`path`,{d:`M10 11v6`,key:`nco0om`}],[`path`,{d:`M14 11v6`,key:`outv1u`}],[`path`,{d:`M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6`,key:`miytrc`}],[`path`,{d:`M3 6h18`,key:`d0wm0j`}],[`path`,{d:`M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2`,key:`e791ji`}]]),Md=md(`tv`,[[`path`,{d:`m17 2-5 5-5-5`,key:`16satq`}],[`rect`,{width:`20`,height:`15`,x:`2`,y:`7`,rx:`2`,key:`1e6viu`}]]),Nd=md(`video`,[[`path`,{d:`m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5`,key:`ftymec`}],[`rect`,{x:`2`,y:`6`,width:`14`,height:`12`,rx:`2`,key:`158x01`}]]),Pd=md(`volume-2`,[[`path`,{d:`M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z`,key:`uqj9uw`}],[`path`,{d:`M16 9a5 5 0 0 1 0 6`,key:`1q6k2b`}],[`path`,{d:`M19.364 18.364a9 9 0 0 0 0-12.728`,key:`ijwkga`}]]),Fd=md(`volume-x`,[[`path`,{d:`M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z`,key:`uqj9uw`}],[`line`,{x1:`22`,x2:`16`,y1:`9`,y2:`15`,key:`1ewh16`}],[`line`,{x1:`16`,x2:`22`,y1:`9`,y2:`15`,key:`5ykzw1`}]]),Id=md(`wifi`,[[`path`,{d:`M12 20h.01`,key:`zekei9`}],[`path`,{d:`M2 8.82a15 15 0 0 1 20 0`,key:`dnpr2z`}],[`path`,{d:`M5 12.859a10 10 0 0 1 14 0`,key:`1x1e6c`}],[`path`,{d:`M8.5 16.429a5 5 0 0 1 7 0`,key:`1bycff`}]]),Ld={x:12,z:8},Rd=1.2,zd=.75,Bd=[{id:`steam`,name:`Steam`,icon:v.createElement(vd),color:`bg-blue-600`,hex:`#2563eb`},{id:`youtube`,name:`YouTube TV`,icon:v.createElement(Nd),color:`bg-red-600`,hex:`#dc2626`},{id:`plex`,name:`Plex`,icon:v.createElement(Md),color:`bg-yellow-500`,hex:`#eab308`},{id:`retroarch`,name:`RetroArch`,icon:v.createElement(yd),color:`bg-slate-600`,hex:`#475569`}],Vd=class{scene;camera;renderer;rt;postScene;postMat;keyLight;meshes=new Map;animFrameId=null;container=null;init(e){this.container=e;let t=window.innerWidth,n=window.innerHeight;this.scene=new Ii,this.scene.background=new q(263178),this.scene.fog=new Fi(263178,12,38),this.camera=new _s(72,t/n,.1,200),this.camera.position.set(0,13,17),this.camera.lookAt(0,0,0),this.renderer=new nd({antialias:!0}),this.renderer.setSize(t,n),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.appendChild(this.renderer.domElement),this.rt=new Qr(t,n),this.postScene=new Ii,new bs(-1,1,1,-1,0,1),this.postMat=new Ro({uniforms:{tDiffuse:{value:this.rt.texture},time:{value:0}},vertexShader:rd,fragmentShader:id}),this.postScene.add(new $a(new ko(2,2),this.postMat)),this.scene.add(new Cs(15485081,.45)),this.keyLight=new Ss(16777215,40),this.keyLight.position.set(14,3,6),this.keyLight.castShadow=!0,this.keyLight.shadow.mapSize.width=4096,this.keyLight.shadow.mapSize.height=4096,this.keyLight.shadow.camera.near=.1,this.keyLight.shadow.camera.far=60,this.keyLight.shadow.camera.left=-30,this.keyLight.shadow.camera.right=30,this.keyLight.shadow.camera.top=30,this.keyLight.shadow.camera.bottom=-30,this.keyLight.shadow.bias=-1e-4,this.scene.add(this.keyLight),this.scene.add(this.keyLight);let r=new ys(16777215,3,16);r.position.set(-6,4,-4),this.scene.add(r);let i=new Bs(Ld.x*4,22,10066414,7829486);i.position.y=-.62,this.scene.add(i),this.animate(0),window.addEventListener(`resize`,this.onResize)}animate=e=>{this.animFrameId=requestAnimationFrame(this.animate);let t=e*.001;this.postMat.uniforms.time.value=t,this.keyLight.position.set(Math.sin(t*.4)*6,6,Math.cos(t*.4)*6),this.renderer.setRenderTarget(this.rt),this.renderer.render(this.scene,this.camera),this.renderer.setRenderTarget(null),this.renderer.render(this.postScene,new bs(-1,1,1,-1,0,1))};syncEntities(e){e.forEach(e=>{if(this.meshes.has(e.id)){let t=this.meshes.get(e.id);t.position.lerp(new U(e.pos.x,0,e.pos.z),.28),Math.hypot(e.vel.x,e.vel.z)>.01&&(t.rotation.x+=e.vel.z*.42,t.rotation.z-=e.vel.x*.42,t.rotation.y+=.012)}else{let t=new $a(new Oo(Rd,Rd,Rd),new Bo({color:e.color,emissive:e.color,emissiveIntensity:0,metalness:.62,roughness:.2}));t.position.set(e.pos.x,0,e.pos.z),this.scene.add(t),this.meshes.set(e.id,t)}}),this.meshes.forEach((t,n)=>{e.find(e=>e.id===n)||(this.scene.remove(t),t.geometry.dispose(),Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material.dispose(),this.meshes.delete(n))})}onResize=()=>{let e=innerWidth,t=innerHeight;this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t),this.rt.setSize(e,t)};dispose(){this.animFrameId&&cancelAnimationFrame(this.animFrameId),window.removeEventListener(`resize`,this.onResize),this.container&&(this.container.innerHTML=``),this.renderer.dispose(),this.rt.dispose()}};function Hd(e){let[t,n]=(0,v.useState)(null),r=(0,v.useRef)(null),i=(0,v.useCallback)(e=>{e&&n(e)},[]);return(0,v.useEffect)(()=>{if(!t)return;let e=new Vd;return e.init(t),r.current=e,()=>{e.dispose(),r.current=null}},[t]),(0,v.useEffect)(()=>{r.current?.syncEntities(e)},[e]),{mountRef:i,sceneRef:r}}var Ud={p1:`#6366f1`,p2:`#ec4899`},Wd=new class{players=[];subscribers=new Set;handleActions(e){e.forEach(e=>{e.type===`move`&&e.playerId&&this.ensurePlayer(e.playerId,e.deviceId,e.deviceType)})}ensurePlayer(e,t,n){if(this.players.find(t=>t.id===e))return;let r={id:e,name:`Player `+e.slice(-1).toUpperCase(),color:Ud[e]??`#ffffff`,pos:{x:(Math.random()-.5)*6,z:(Math.random()-.5)*5},vel:{x:0,z:0},deviceId:t};this.players=[...this.players,r],this.subscribers.forEach(e=>e(this.players))}subscribe(e){return this.subscribers.add(e),()=>this.subscribers.delete(e)}},Gd=.025,Kd=.94;function qd(e,t){let n=new Map;for(let e of t)e.type===`move`&&e.playerId&&typeof e.value==`object`&&`x`in e.value&&n.set(e.playerId,{x:e.value.x,y:e.value.y});let r=e.map(e=>{let t=n.get(e.id)??{x:0,y:0},r=t.x*Gd,i=t.y*Gd;return{...e,vel:{x:(e.vel.x+r)*Kd,z:(e.vel.z+i)*Kd}}});r=r.map(e=>({...e,pos:{x:e.pos.x+e.vel.x,z:e.pos.z+e.vel.z}}));for(let e=0;e<r.length;e++)for(let t=e+1;t<r.length;t++){let n=r[e],i=r[t],a=i.pos.x-n.pos.x,o=i.pos.z-n.pos.z,s=Math.hypot(a,o),c=zd*2;if(s<c&&s>.001){let e=Math.atan2(o,a),t=c-s,r=t/2*Math.cos(e),l=t/2*Math.sin(e);n.pos.x-=r,n.pos.z-=l,i.pos.x+=r,i.pos.z+=l;let u=a/s,d=o/s,f=.78,p=n.vel.x*u+n.vel.z*d-(i.vel.x*u+i.vel.z*d);n.vel.x-=p*u*f,n.vel.z-=p*d*f,i.vel.x+=p*u*f,i.vel.z+=p*d*f}}return r=r.map(e=>{let{x:t,z:n}=e.pos,{x:r,z:i}=e.vel;return t>Ld.x&&(t=Ld.x,r*=-.5),t<-Ld.x&&(t=-Ld.x,r*=-.5),n>Ld.z&&(n=Ld.z,i*=-.5),n<-Ld.z&&(n=-Ld.z,i*=-.5),{...e,pos:{x:t,z:n},vel:{x:r,z:i}}}),r}var Jd={players:[],count:0},Yd=new Set;function Xd(){Jd={players:[...Wd.players],count:Wd.players.length},Yd.forEach(e=>e())}function Zd(){return(0,v.useEffect)(()=>w.onActions(e=>{Wd.handleActions(e),Wd.players=qd(Wd.players,e),Xd()}),[]),{players:Jd.players,count:Jd.count}}function Qd(){let[e,t]=(0,v.useState)(new Date);return(0,v.useEffect)(()=>{let e=setInterval(()=>t(new Date),1e3);return()=>clearInterval(e)},[]),e}var $d=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),$=o(((e,t)=>{t.exports=$d()}))();function ef(){return(0,$.jsxs)(`div`,{className:`h-screen w-screen bg-black flex flex-col items-center justify-center text-white`,children:[(0,$.jsxs)(`div`,{className:`relative mb-8`,children:[(0,$.jsx)(`div`,{className:`w-24 h-24 border-[5px] border-indigo-500 border-t-transparent rounded-full animate-spin`}),(0,$.jsx)(`div`,{className:`absolute inset-0 flex items-center justify-center`,children:(0,$.jsx)(`img`,{src:`drakoon.svg`,alt:`Drakoon`})})]}),(0,$.jsx)(`p`,{className:`text-[11px] font-black tracking-[0.55em] uppercase text-indigo-300/60 mb-1`,children:`JDrakoon v3.0`}),(0,$.jsx)(`p`,{className:`text-[10px] text-gray-700 font-bold uppercase tracking-widest`,children:`Lonezsi`})]})}function tf({clock:e,players:t}){let n=e.toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`});return(0,$.jsxs)(`div`,{className:`flex justify-between items-start mb-2`,children:[(0,$.jsxs)(`div`,{className:`flex items-center gap-4`,children:[(0,$.jsx)(`div`,{className:`w-12 h-12 bg-indigo-600 rounded-2xl flex items-center justify-center shadow-lg shadow-indigo-500/40 flex-shrink-0`,children:(0,$.jsx)(`img`,{src:`drakoon.svg`,alt:`Drakoon`})}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`h1`,{className:`text-xl font-black uppercase tracking-tight italic leading-none`,children:`JDrakoon 3`}),(0,$.jsxs)(`div`,{className:`flex items-center gap-2 mt-1`,children:[(0,$.jsx)(`span`,{className:`w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse flex-shrink-0`}),(0,$.jsxs)(`p`,{className:`text-[10px] text-indigo-400 font-bold uppercase tracking-widest`,children:[t.length,` Active ·\xA0`,(0,$.jsx)(`span`,{className:`text-gray-500`,children:`WIFI: LIVING_ROOM_5G`})]})]})]})]}),(0,$.jsxs)(`div`,{className:`flex items-center gap-5`,children:[(0,$.jsxs)(`div`,{className:`text-right`,children:[(0,$.jsx)(`span`,{className:`text-3xl font-mono leading-none block tabular-nums`,children:n}),(0,$.jsx)(`span`,{className:`text-[10px] text-gray-600 font-bold uppercase tracking-widest mt-1 block`,children:`CRT Active · Physics On`})]}),(0,$.jsx)(`div`,{className:`p-3 bg-white/5 rounded-2xl border border-white/10 text-indigo-400`,children:(0,$.jsx)(Ad,{size:20})})]})]})}function nf({activeIndex:e,setActiveIndex:t}){return(0,$.jsxs)(`div`,{className:`flex-1 flex flex-col justify-center gap-6`,children:[(0,$.jsxs)(`div`,{className:`flex items-center gap-3 px-2`,children:[(0,$.jsx)(`span`,{className:`px-2.5 py-1 bg-indigo-500 rounded text-[10px] font-black uppercase tracking-wider`,children:`Featured`}),(0,$.jsx)(`span`,{className:`text-[10px] font-black text-gray-600 uppercase tracking-widest`,children:`Application Library`})]}),(0,$.jsxs)(`div`,{className:`flex gap-5 items-center h-64 overflow-visible px-2`,children:[Bd.map((n,r)=>{let i=e===r;return(0,$.jsxs)(`div`,{className:`relative flex-shrink-0 transition-all duration-500 ${i?`w-60 h-60 scale-110 z-10`:`w-44 h-44 opacity-40 grayscale`}`,children:[i&&(0,$.jsx)(`div`,{className:`absolute inset-0 blur-3xl opacity-25 rounded-3xl ${n.color}`}),(0,$.jsxs)(`div`,{className:`w-full h-full rounded-3xl p-5 flex flex-col justify-between relative z-10 border cursor-pointer
                  ${i?`bg-white/10 backdrop-blur-2xl border-white/35 shadow-2xl`:`bg-white/5 border-white/8`}`,onClick:()=>{t(r),i&&C(n)},children:[(0,$.jsx)(`div`,{className:`w-12 h-12 rounded-2xl flex items-center justify-center ${n.color} shadow-lg`,children:v.cloneElement(n.icon,{size:26})}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`h3`,{className:`text-xl font-black tracking-tight italic uppercase leading-none`,children:n.name}),(0,$.jsx)(`p`,{className:`text-[10px] text-gray-500 mt-1 uppercase font-black`,children:i?`Press Enter / Click`:`Local App`})]}),i&&(0,$.jsx)(`div`,{className:`absolute -bottom-3 right-5 bg-indigo-500 p-1.5 rounded-full shadow-lg shadow-indigo-500/50`,children:(0,$.jsx)(gd,{size:16})})]})]},n.id)}),(0,$.jsxs)(`div`,{className:`flex-shrink-0 w-44 h-44 rounded-3xl border-2 border-dashed border-white/10 flex flex-col items-center justify-center text-gray-700 cursor-pointer hover:text-gray-500 hover:border-white/20 transition-colors`,onClick:()=>S.push(`Add new app: drag an .exe or enter a Steam URI.`),children:[(0,$.jsx)(Ed,{size:20}),(0,$.jsx)(`span`,{className:`text-[10px] font-bold mt-2 uppercase tracking-widest`,children:`Add System`})]})]})]})}var rf=[{id:1,title:`Lofi Hip Hop Radio`,channel:`ChilledCow`,duration:`LIVE`,thumb:`https://images.unsplash.com/photo-1516280440614-37939bbacd81?w=120&q=70`,addedBy:`System`},{id:2,title:`Planet Earth II – Forests`,channel:`BBC Earth`,duration:`12:45`,thumb:`https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=120&q=70`,addedBy:`System`},{id:3,title:`Synthwave Mix 2024`,channel:`NightDrive`,duration:`1:02:33`,thumb:`https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=120&q=70`,addedBy:`System`}];function af(){let[e,t]=(0,v.useState)(rf),[n,r]=(0,v.useState)(0),[i,a]=(0,v.useState)(!1),[o,s]=(0,v.useState)(0),[c,l]=(0,v.useState)(72),[u,d]=(0,v.useState)(!1),[f,p]=(0,v.useState)(!1),m=e[n]??null,h=(0,v.useRef)(null);(0,v.useEffect)(()=>(i&&m&&m.duration!==`LIVE`&&(h.current=window.setInterval(()=>{s(e=>e>=100?(_(),0):e+.1*100/12)},100)),()=>{h.current&&clearInterval(h.current)}),[i,m]);let g=(0,v.useCallback)(()=>a(e=>!e),[]),_=(0,v.useCallback)(()=>{r(t=>(t+1)%e.length),s(0),a(!0)},[e.length]);return{currentItem:m,isPlaying:i,progress:o,volume:c,muted:u,isFullscreen:f,queue:e,handlePlayPause:g,handleNext:_,handlePrev:(0,v.useCallback)(()=>{r(t=>(t-1+e.length)%e.length),s(0),a(!0)},[e.length]),handleSeek:(0,v.useCallback)(e=>s(e),[]),handleVolumeChange:(0,v.useCallback)(e=>{l(e),d(!1)},[]),toggleMute:(0,v.useCallback)(()=>d(e=>!e),[]),toggleFullscreen:(0,v.useCallback)(()=>p(e=>!e),[]),addToQueue:(0,v.useCallback)((e,n=`You`)=>{let r=e.length>40?e.slice(0,40)+`…`:e,i={id:Date.now(),title:r,channel:`Added manually`,duration:`--:--`,thumb:`https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=120&q=70`,url:e,addedBy:n};t(e=>[...e,i])},[]),removeFromQueue:(0,v.useCallback)(i=>{t(e=>e.filter((e,t)=>t!==i)),i===n&&e.length>1&&(r(Math.min(n,e.length-2)),s(0))},[n,e.length]),moveUp:(0,v.useCallback)(e=>{e!==0&&t(t=>{let n=[...t];return[n[e-1],n[e]]=[n[e],n[e-1]],n})},[]),moveDown:(0,v.useCallback)(n=>{n!==e.length-1&&t(e=>{let t=[...e];return[t[n],t[n+1]]=[t[n+1],t[n]],t})},[e.length]),clearQueue:(0,v.useCallback)(()=>{t([]),r(0),s(0),a(!1)},[]),currentIndex:n}}function of({players:e}){let t=af(),[n,r]=(0,v.useState)(``),i=()=>{if(n.trim()){let i=e.length>0?e[0].name:`System`;t.addToQueue(n.trim(),i),r(``)}};return(0,$.jsxs)(`div`,{className:`flex items-end gap-6 py-4`,children:[(0,$.jsxs)(`div`,{className:`flex flex-col gap-2.5 flex-shrink-0`,children:[(0,$.jsx)(`h3`,{className:`text-[10px] font-black text-gray-600 uppercase tracking-widest`,children:`In the Lobby`}),(0,$.jsxs)(`div`,{className:`flex -space-x-2.5 min-h-[48px] items-center`,children:[e.map(e=>(0,$.jsx)(`div`,{style:{backgroundColor:e.color},className:`w-11 h-11 rounded-full border-[3px] border-[#04040a] flex items-center justify-center text-[11px] font-black shadow-lg hover:z-10 hover:scale-110 transition-transform relative`,title:e.name,children:e.name[0]},e.id)),e.length===0&&(0,$.jsx)(`p`,{className:`text-[10px] text-gray-700 italic`,children:`WASD · UJHK to join`})]})]}),(0,$.jsxs)(`div`,{className:`flex-1 bg-white/5 rounded-3xl border border-white/10 p-4 flex flex-col gap-2 min-w-0`,children:[(0,$.jsxs)(`div`,{className:`flex items-center gap-4`,children:[(0,$.jsx)(`div`,{className:`p-2.5 bg-indigo-500/20 rounded-xl text-indigo-400 flex-shrink-0`,children:(0,$.jsx)(Cd,{size:18})}),(0,$.jsxs)(`div`,{className:`flex-1 min-w-0`,children:[(0,$.jsx)(`h3`,{className:`text-[10px] font-black text-gray-600 uppercase tracking-widest mb-1`,children:t.currentItem?t.isPlaying?`Now Playing`:`Paused`:`No Media`}),(0,$.jsx)(`div`,{className:`flex items-center gap-2`,children:t.currentItem&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`img`,{src:t.currentItem.thumb,className:`w-8 h-8 rounded-lg object-cover flex-shrink-0`,alt:``}),(0,$.jsxs)(`div`,{className:`min-w-0 leading-tight`,children:[(0,$.jsx)(`p`,{className:`text-xs font-black text-white truncate`,children:t.currentItem.title}),(0,$.jsxs)(`p`,{className:`text-[10px] text-gray-500`,children:[t.currentItem.channel,` · added by`,` `,t.currentItem.addedBy]})]})]})})]}),(0,$.jsxs)(`div`,{className:`flex items-center gap-1.5`,children:[(0,$.jsx)(`button`,{onClick:t.handlePrev,className:`p-2 rounded-lg text-slate-400 hover:text-white hover:bg-white/10 disabled:opacity-20`,children:(0,$.jsx)(Od,{size:14})}),(0,$.jsx)(`button`,{onClick:t.handlePlayPause,className:`p-2 bg-indigo-600 rounded-full text-white shadow-lg shadow-indigo-500/30 hover:scale-105 active:scale-95`,children:t.isPlaying?(0,$.jsx)(wd,{size:16}):(0,$.jsx)(Td,{size:16,className:`ml-px`})}),(0,$.jsx)(`button`,{onClick:t.handleNext,className:`p-2 rounded-lg text-slate-400 hover:text-white hover:bg-white/10 disabled:opacity-20`,children:(0,$.jsx)(kd,{size:14})})]})]}),(0,$.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,$.jsx)(`span`,{className:`text-[10px] text-gray-500 font-mono w-10 text-right`,children:t.currentItem?.duration===`LIVE`?`LIVE`:`${Math.floor(t.progress*.45)}:${String(Math.floor(t.progress*.45%1*60)).padStart(2,`0`)}`}),(0,$.jsx)(`input`,{type:`range`,min:0,max:100,value:t.progress,onChange:e=>t.handleSeek(+e.target.value),className:`flex-1 h-1.5 appearance-none rounded-full`,style:{accentColor:`#6366f1`,background:`linear-gradient(90deg,#6366f1, #a78bfa)`}}),(0,$.jsx)(`span`,{className:`text-[10px] text-gray-500 font-mono w-10`,children:t.currentItem?.duration===`LIVE`?`∞`:t.currentItem?.duration||`--:--`})]}),(0,$.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,$.jsx)(`button`,{onClick:t.toggleMute,className:`text-slate-500 hover:text-white`,children:t.muted?(0,$.jsx)(Fd,{size:14}):(0,$.jsx)(Pd,{size:14})}),(0,$.jsx)(`input`,{type:`range`,min:0,max:100,value:t.muted?0:t.volume,onChange:e=>t.handleVolumeChange(+e.target.value),className:`w-20 h-1 appearance-none rounded-full`,style:{accentColor:`#6366f1`}}),(0,$.jsx)(`span`,{className:`text-[10px] font-black text-slate-500 w-5`,children:t.muted?0:t.volume}),(0,$.jsx)(`button`,{onClick:t.toggleFullscreen,className:`p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-white/10`,children:t.isFullscreen?(0,$.jsx)(Sd,{size:14}):(0,$.jsx)(xd,{size:14})}),t.queue.length>0&&(0,$.jsx)(`button`,{onClick:t.clearQueue,className:`ml-auto text-[10px] text-red-400 font-black uppercase tracking-wider hover:text-red-300`,children:`Clear`})]})]}),(0,$.jsxs)(`div`,{className:`mt-3`,children:[(0,$.jsx)(`h3`,{className:`text-[10px] font-black text-gray-600 uppercase tracking-widest mb-1`,children:`Queue`}),(0,$.jsxs)(`div`,{className:`flex gap-2 overflow-x-auto py-1 custom-scroll`,children:[t.queue.length===0&&(0,$.jsx)(`p`,{className:`text-[10px] text-gray-700 italic text-center py-2`,children:`Empty`}),t.queue.map((e,n)=>(0,$.jsxs)(`div`,{className:`w-44 flex-shrink-0 flex items-start gap-2 rounded-xl p-2 border ${n===t.currentIndex?`border-indigo-500/40 bg-indigo-500/10`:`border-white/5 bg-white/5`}`,children:[(0,$.jsx)(`img`,{src:e.thumb,className:`w-12 h-12 rounded object-cover flex-shrink-0`,alt:``}),(0,$.jsxs)(`div`,{className:`flex-1 min-w-0`,children:[(0,$.jsx)(`p`,{className:`text-[10px] font-bold text-white truncate leading-tight`,children:e.title}),(0,$.jsxs)(`p`,{className:`text-[8px] text-gray-500`,children:[e.channel,` · `,e.addedBy]})]}),(0,$.jsxs)(`div`,{className:`flex flex-col items-center justify-between`,children:[(0,$.jsx)(`button`,{onClick:()=>t.moveUp(n),disabled:n===0,className:`p-0.5 text-slate-600 hover:text-white disabled:opacity-20`,children:(0,$.jsx)(_d,{size:12})}),(0,$.jsx)(`button`,{onClick:()=>t.moveDown(n),disabled:n===t.queue.length-1,className:`p-0.5 text-slate-600 hover:text-white disabled:opacity-20`,children:(0,$.jsx)(hd,{size:12})})]}),(0,$.jsx)(`button`,{onClick:()=>t.removeFromQueue(n),className:`p-0.5 text-slate-700 hover:text-red-400`,children:(0,$.jsx)(jd,{size:12})})]},e.id))]}),(0,$.jsxs)(`div`,{className:`flex gap-1 mt-2`,children:[(0,$.jsx)(`input`,{type:`text`,value:n,onChange:e=>r(e.target.value),onKeyDown:e=>e.key===`Enter`&&i(),placeholder:`Add URL…`,className:`flex-1 bg-white/5 border border-white/10 rounded-lg px-2 py-1 text-[10px] text-white placeholder-gray-600 outline-none`,style:{caretColor:`#6366f1`}}),(0,$.jsx)(`button`,{onClick:i,className:`p-1 bg-indigo-600 rounded-lg text-white active:scale-90`,children:(0,$.jsx)(Ed,{size:12})})]})]}),(0,$.jsxs)(`div`,{className:`flex gap-2.5 flex-shrink-0`,children:[(0,$.jsx)(`button`,{onClick:()=>{},className:`p-3.5 bg-white/5 rounded-2xl border border-white/10 text-gray-500 hover:text-white hover:bg-white/10 transition-colors`,children:(0,$.jsx)(Dd,{size:18})}),(0,$.jsx)(`button`,{onClick:()=>{},className:`p-3.5 bg-red-500/10 rounded-2xl border border-red-500/20 text-red-500 hover:bg-red-500/20 transition-colors`,children:(0,$.jsx)(bd,{size:18})})]}),t.isFullscreen&&(0,$.jsx)(`div`,{className:`fixed inset-0 z-50 bg-black/90 flex items-center justify-center backdrop-blur-sm`,children:(0,$.jsx)(`div`,{className:`w-full max-w-4xl p-8`,children:(0,$.jsxs)(`div`,{className:`bg-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl p-8 flex flex-col gap-6`,children:[(0,$.jsxs)(`div`,{className:`flex items-center gap-4`,children:[(0,$.jsx)(`img`,{src:t.currentItem?.thumb,className:`w-24 h-24 rounded-2xl object-cover shadow-2xl`,alt:``}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`h1`,{className:`text-2xl font-black text-white`,children:t.currentItem?.title||`No Media`}),(0,$.jsxs)(`p`,{className:`text-sm text-gray-400 mt-1`,children:[t.currentItem?.channel,` · added by`,` `,t.currentItem?.addedBy]}),(0,$.jsx)(`p`,{className:`text-xs text-indigo-400 font-bold mt-2`,children:t.isPlaying?`● Playing`:`❚❚ Paused`})]})]}),(0,$.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,$.jsx)(`span`,{className:`text-gray-400 font-mono text-sm`,children:t.currentItem?.duration===`LIVE`?`LIVE`:`${Math.floor(t.progress*.45)}:${String(Math.floor(t.progress*.45%1*60)).padStart(2,`0`)}`}),(0,$.jsx)(`input`,{type:`range`,min:0,max:100,value:t.progress,onChange:e=>t.handleSeek(+e.target.value),className:`flex-1 h-2 appearance-none rounded-full`,style:{accentColor:`#6366f1`}}),(0,$.jsx)(`span`,{className:`text-gray-400 font-mono text-sm`,children:t.currentItem?.duration||`--:--`})]}),(0,$.jsxs)(`div`,{className:`flex items-center justify-center gap-8`,children:[(0,$.jsx)(`button`,{onClick:t.handlePrev,className:`text-white/70 hover:text-white`,children:(0,$.jsx)(Od,{size:32})}),(0,$.jsx)(`button`,{onClick:t.handlePlayPause,className:`w-20 h-20 rounded-full bg-indigo-600 flex items-center justify-center shadow-2xl shadow-indigo-500/30 hover:scale-105`,children:t.isPlaying?(0,$.jsx)(wd,{size:36,className:`text-white`}):(0,$.jsx)(Td,{size:36,className:`text-white ml-1`})}),(0,$.jsx)(`button`,{onClick:t.handleNext,className:`text-white/70 hover:text-white`,children:(0,$.jsx)(kd,{size:32})})]}),(0,$.jsxs)(`div`,{className:`flex items-center gap-4 justify-center`,children:[(0,$.jsx)(`button`,{onClick:t.toggleMute,className:`text-white/70 hover:text-white`,children:t.muted||t.volume===0?(0,$.jsx)(Fd,{size:24}):(0,$.jsx)(Pd,{size:24})}),(0,$.jsx)(`input`,{type:`range`,min:0,max:100,value:t.muted?0:t.volume,onChange:e=>t.handleVolumeChange(+e.target.value),className:`w-48 h-1.5 appearance-none rounded-full`,style:{accentColor:`#6366f1`}}),(0,$.jsx)(`span`,{className:`text-white font-bold`,children:t.muted?0:t.volume})]}),(0,$.jsx)(`button`,{onClick:t.toggleFullscreen,className:`self-end text-white/60 hover:text-white underline text-sm font-bold`,children:`Exit Fullscreen`})]})})})]})}function sf({clock:e,players:t,activeIndex:n,setActiveIndex:r}){return(0,$.jsxs)(`div`,{className:`relative z-10 h-full w-full flex flex-col p-10`,children:[(0,$.jsx)(tf,{clock:e,players:t}),(0,$.jsx)(nf,{activeIndex:n,setActiveIndex:r}),(0,$.jsx)(of,{players:t})]})}function cf(){return(0,$.jsx)(`div`,{className:`fixed inset-0 z-20 flex items-center justify-center`,children:(0,$.jsxs)(`div`,{className:`text-center`,children:[(0,$.jsx)(`div`,{className:`w-12 h-12 border-2 border-indigo-500 border-t-transparent rounded-full animate-spin mx-auto mb-4`}),(0,$.jsx)(`p`,{className:`text-xs font-black tracking-[0.4em] uppercase text-indigo-300/60`,children:`Launching…`})]})})}function lf(){let[e,t]=(0,v.useState)([]);return(0,v.useEffect)(()=>S.subscribe(t),[]),(0,$.jsx)(`div`,{className:`fixed top-8 right-8 z-50 flex flex-col gap-2.5 pointer-events-none`,children:e.map(e=>(0,$.jsxs)(`div`,{className:`bg-indigo-600 text-white px-5 py-3.5 rounded-2xl text-sm font-black notif shadow-2xl border border-indigo-400/40 flex items-center gap-3`,children:[(0,$.jsx)(`div`,{className:`w-1 h-5 bg-white/35 rounded-full flex-shrink-0`}),e.text]},e.id))})}function uf(){return(0,$.jsx)(`div`,{className:`fixed bottom-30 right-10 z-50 opacity-15 hover:opacity-95 transition-opacity duration-300 cursor-pointer`,onClick:()=>S.push(`Phone pairing: open 192.168.1.x:3000 on your phone.`),children:(0,$.jsxs)(`div`,{className:`bg-white p-2.5 rounded-2xl shadow-2xl`,children:[(0,$.jsx)(`div`,{className:`w-[72px] h-[72px] bg-gray-900 rounded-lg grid grid-cols-3 gap-[2px] p-1.5`,children:Array.from({length:9}).map((e,t)=>(0,$.jsx)(`div`,{className:`rounded-[2px] ${[0,2,6,8,4].includes(t)?`bg-white`:`bg-gray-700`}`},t))}),(0,$.jsxs)(`div`,{className:`flex items-center gap-1 mt-1.5 px-0.5`,children:[(0,$.jsx)(Id,{size:9,className:`text-gray-500`}),(0,$.jsx)(`p`,{className:`text-[8px] text-gray-500 font-bold`,children:`:3000`})]})]})})}function df(){let[e,t]=(0,v.useState)(`BOOT`),[n,r]=(0,v.useState)(0),[i,a]=(0,v.useState)([]),o=Zd(),s=Qd(),c=(0,v.useMemo)(()=>{let e=new Set(i.map(e=>e.id)),t=o.players.filter(t=>!e.has(t.id));return[...i,...t]},[i,o.players]),{mountRef:l,sceneRef:u}=Hd(c);return(0,v.useEffect)(()=>{if(e!==`BOOT`)return;let n=setTimeout(()=>{x.transition(`HOME`),t(`HOME`)},2600);return()=>clearTimeout(n)},[e]),(0,v.useEffect)(()=>{if(e===`BOOT`)return;let t=Mt({name:`TV Console`,color:`#10b981`}),n=Nt(e=>{switch(e.type){case`lobby_state`:a(e.players||[]);break;case`player_joined`:a(t=>t.find(t=>t.id===e.id)?t:[...t,e]);break;case`player_left`:a(t=>t.filter(t=>t.id!==e.playerId));break;default:break}});return()=>{n(),t?.disconnect()}},[e]),(0,v.useEffect)(()=>{if(e===`BOOT`)return;let t=w.start(),n=w.onActions(e=>{e.forEach(e=>{if(e.type===`move`||e.type===`emote`||e.type===`jump`||e.type===`navigate`||e.type===`confirm`)Pt({type:`action`,payload:e});else{let t={type:`input`};e.value&&typeof e.value==`object`&&(t.analog=e.value),e.buttons&&(t.buttons=e.buttons),Pt({type:`input:event`,payload:t})}})});return()=>{n(),t()}},[e]),(0,v.useEffect)(()=>b.on(`state:change`,e=>t(e)),[]),(0,v.useEffect)(()=>w.onActions(e=>{x.current===`HOME`&&e.forEach(e=>{e.type===`navigate`&&typeof e.value==`object`&&`direction`in e.value&&(e.value.direction===`right`&&r(e=>Math.min(e+1,Bd.length-1)),e.value.direction===`left`&&r(e=>Math.max(e-1,0))),e.type===`confirm`&&C(Bd[n])})}),[n]),e===`BOOT`?(0,$.jsx)(ef,{}):(0,$.jsxs)(`div`,{className:`h-screen w-screen bg-[#04040a] text-slate-100 overflow-hidden select-none`,style:{fontFamily:`'Segoe UI', system-ui, sans-serif`},children:[(0,$.jsx)(`div`,{ref:l,className:`fixed inset-0 z-0 pointer-events-none`}),(0,$.jsx)(`div`,{className:`h-full transition-all duration-700 ${e===`APP_RUNNING`?`opacity-0 scale-95 blur-2xl pointer-events-none`:``}`,children:(0,$.jsx)(sf,{clock:s,players:c,activeIndex:n,setActiveIndex:r})}),e===`APP_RUNNING`&&(0,$.jsx)(cf,{}),(0,$.jsx)(lf,{}),(0,$.jsx)(uf,{}),(0,$.jsx)(`style`,{children:`
        @keyframes notif-in {
          from { transform: translateX(110%); opacity: 0; }
          to   { transform: translateX(0);    opacity: 1; }
        }
        .notif { animation: notif-in 0.38s cubic-bezier(.19,1,.22,1) forwards; }
      `})]})}y.createRoot(document.getElementById(`root`)).render((0,$.jsx)(v.StrictMode,{children:(0,$.jsx)(df,{})}));