    ...
    >
      ...
      <div className="w-full max-w-sm space-y-5">
        <div>
          ...
          />
          {err && (
            <p className="text-red-400 text-xs mt-1.5 font-bold">{err}</p>
          )}
        </div>
        ...
        <div>
          ...
          <div className="flex gap-3 items-center flex-wrap w-full justify-between">
            {AVATAR_COLORS.map((c) => {
              const selected = color.name === c.name && color.hex === c.hex;
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    boxShadow: selected
                      ? `0 0 0 3px #06060c, 0 0 0 5.5px ${c.hex}`
                      : "none",
            ...
            <div className="relative w-11 h-11 flex-shrink-0">
              <input
                type="color"
                value={color.name === "Custom" ? color.hex : "#ffffff"}
                onChange={(e) =>
                  setColor({
                    hex: e.target.value,
                    name: "Custom",
              ...
              <div
                className="w-11 h-11 rounded-full border-2 border-dashed border-slate-500 flex items-center justify-center transition-all pointer-events-none"
                style={{
                  backgroundColor:
                    color.name === "Custom" ? color.hex : "transparent",
                  boxShadow:
                    color.name === "Custom"
                      ? `0 0 0 3px #06060c, 0 0 0 5.5px ${color.hex}`
                      : "none",
                  transform:
                    color.name === "Custom" ? "scale(1.18)" : "scale(1)",
                }}
              >
                {color.name === "Custom" ? (
                  <Check size={15} className="text-white" strokeWidth={3} />
        ...
        <button
          ...
          style={{
            ...
            boxShadow: `0 10px 28px ${color.hex}45`,
          }}
        >
          Join the Couch →
        </button>
        ...
        <button
          onClick={() => onJoin("Guest", AVATAR_COLORS[3])}
